...
from hermes.cores.cli import CLI
from hermes.cores.helpers import get_resource
from hermes.cores.storage import Storage
from hermes.cores.tree_store import TreeStore
...
class SampleReset:
    ...
    def run(self, script: str, arguments: dict[str, Any], config: dict[str, Any], storage: Storage) -> None:
        ...
        tree_store = TreeStore(mecon_container, Sample.TREESTORE)
